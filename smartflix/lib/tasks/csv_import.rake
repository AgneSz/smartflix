...
namespace :copy do 
  ...
  task :data => :environment do 
    ...
    # Type as a column name is restricted in Active Records, type from CSV => movie_type in schema
    Movie.copy_from_client [:movie_type, :title, :director, :cast, :country, :date_added, :release_year, :rating, :duration, :listed_in, :description, :created_at, :updated_at] do |copy|
     movies.each do |d|
